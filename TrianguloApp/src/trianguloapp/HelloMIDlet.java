...
exitMIDlet();//GEN-LINE:|7-commandAction|2|19-postAction
                ...
                int intAltura;
                int intArea;
                intBase=Integer.parseInt(textField.getString());
                intAltura=Integer.parseInt(textField1.getString());
                intArea=(intBase*intAltura)/2;
                textField2.setString(""+ intArea);
...
//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
form = new Form("Welcome", new Item[]{getTextField(), getTextField1(), getTextField2()});//GEN-BEGIN:|14-getter|1|14-postInit
...
//GEN-END:|22-getter|0|22-preInit
 // write pre-init user code here
okCommand = new Command("Calcular", Command.OK, 0);//GEN-LINE:|22-getter|1|22-postInit
 // write post-init user code here
...
//GEN-END:|24-getter|0|24-preInit
 // write pre-init user code here
textField = new TextField("Base", null, 32, TextField.ANY);//GEN-LINE:|24-getter|1|24-postInit
 // write post-init user code here
...
//GEN-END:|25-getter|0|25-preInit
 // write pre-init user code here
textField1 = new TextField("Altura", null, 32, TextField.ANY);//GEN-LINE:|25-getter|1|25-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField2 ">//GEN-BEGIN:|26-getter|0|26-preInit
    /**
...
//GEN-END:|26-getter|0|26-preInit
 // write pre-init user code here
textField2 = new TextField("Area", null, 32, TextField.ANY);//GEN-LINE:|26-getter|1|26-postInit
 // write post-init user code here
